...
namespace loggingapp
{
  ...
  public:
    ...
    void execute_request(
      ...
      ccf::endpoints::EndpointContext& endpoint_ctx)
    {
      CCF_APP_INFO("YYYYYYYYYYYYYYYYYY execute_request YYYYYYYYYYYYYYYYYYYY");
      ...
      ccf::endpoints::EndpointContext& endpoint_ctx) override
    {
      ...
      // Necessary to create the historical adapter on endpoints declared as
      // such in the app.json
      CCF_APP_INFO(
        "XXXXXXXXXXXXXXXXXXX execute_endpoint XXXXXXXXXXXXXXXXXXXXX");
